...
同时单击 `右方向键` 仍旧是 mpv 默认的快进5秒，并没有影响到默认快捷键

## 完结撒花~

### 结束后还要说的事情

`inputevent.lua` 脚本是对 mpv 的 input.conf 做了增强，不仅能实现本文所讲的功能，还能自由搭配，实现更多功能，详情请参考官方文档：https://github.com/natural-harmonia-gropius/input-event
