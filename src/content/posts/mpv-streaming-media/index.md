...
description: 借助 yt-dlp 等工具来优化 mpv 播放器的在线视频体验
...
我的 mpv 自用配置：
::github{repo="Yukari0201/mpv-config"}
...
<iframe width="100%" height="468" src="//player.bilibili.com/player.html?bvid=BV1nQ4y1a7gw&p=2" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
